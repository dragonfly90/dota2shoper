...
//	};
	...
	public class Item
	{
		...
		public Item(ItemId id, int charges) {
			Id = id;
			Charges = charges;
		}

		public static ItemId GetIdByName(string name) {
			return ItemId.empty;
		}

		static public bool IsConsumable(ItemId id) {
		// fred
//			if (id >= ItemId.cheese && id <= ItemId.ward_sentry) {
//				return true;
//			}
			return false;
		}
		public bool IsConsumable() {
			return IsConsumable(Id);
		}

		static public bool IsPurchasable(ItemId id) {
		//fred
//			if (id >= ItemId.bottle) {
				return true;
//			}
//			return false;
		...
		public bool IsPurchasable() {
			return IsPurchasable(Id);
		}

		static public bool IsUpgrade(ItemId id) {
		//fred
//			if (id >= ItemId.bracer) {
//				return true;
//			}
